 ...
 */
@Autonomous
public class FINALBLUE extends LinearOpMode {
    ...
    private static double BACKVEL = 20;

    private static double BACKACCEL = 20;

    private static double SETVEL = 7.5;

    private static double SETACCEL = 7.5;

    private static double SETD = 3;
