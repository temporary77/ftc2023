...
@Disabled
@Autonomous
public class rsv extends LinearOpMode {
...
//                        SampleMecanumDrive.getAccelerationConstraint(SETVEL))
                .forward(SETD+3.5)
                .strafeLeft(2+2-3.5+4.5-5.5) // -1.5
                .build();
        ...
        TrajectorySequence traj0_0i = drive.trajectorySequenceBuilder(traj0_0.end())
                .forward(1)
                .build();
